...
//! can be used to generate a newly transformed template.
//!
//! # Examples
//!
//!     # use std::error;
...
//!         .select("title", |html| html.replace_content("New Title"))
//!         .select("#items", |html| html
//!             .repeat([2, 3, 4], |html, value| html
//!                 .replace_content(format!("Item {}", value))
//!             )
//!         )
//!     )?;
//!     # Ok(())
